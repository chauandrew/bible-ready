 ...
 * Categories are already human-readable (an arc/section name for a single-book quiz,
 * a book name for a whole-Bible one — see QuizRunner's `categorize` prop), so there's
 * no label lookup to do here. */

 ...
 * prepositions dropped so "Lord of the Sabbath" doesn't require "the". Grade
 * with `{ terms, minTerms: 1, titleTerms: [] }` — any one phrase fully present
 * in the typed text is correct. */
